...
class Job(Base, TimestampMixin):
    ...
    salary_is_stated: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
...
class JobRequirements(Base):
    ...
    languages_required: Mapped[dict[str, str]] = mapped_column(JSONB, nullable=False, default=dict)
